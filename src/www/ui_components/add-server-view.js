...
Polymer({
  _template: html`
    ...
    <paper-dialog id="addServerSheet" with-backdrop="">
      ...
      <paper-input id="accessKeyInput" class="shadow" label="[[localize('server-access-key-label', 'ssProtocol', 'ss://')]]" no-label-float="" value="{{accessKey}}" pattern="((ss://)|(ssconf://)|(https://)).*">
